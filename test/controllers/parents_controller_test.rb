...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { User_id: @parent.User_id, email: @parent.email, mobil_phone: @parent.mobil_phone, name: @parent.name } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { User_id: @parent.User_id, email: @parent.email, mobil_phone: @parent.mobil_phone, name: @parent.name } }
