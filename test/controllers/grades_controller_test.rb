...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { Evaluation_id: @grade.Evaluation_id, Student_id: @grade.Student_id, grade: @grade.grade } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { Evaluation_id: @grade.Evaluation_id, Student_id: @grade.Student_id, grade: @grade.grade } }
