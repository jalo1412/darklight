...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { Teacher_id: @lecture.Teacher_id, level: @lecture.level, name: @lecture.name, program: @lecture.program, year: @lecture.year } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { Teacher_id: @lecture.Teacher_id, level: @lecture.level, name: @lecture.name, program: @lecture.program, year: @lecture.year } }
